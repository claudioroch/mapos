...
<head>
  <title><?= $configuration['app_name'] ?: 'DoctorMap-OS' ?></title>
  <meta charset="UTF-8" />
...
<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'DoctorMap-OS' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      <li class=""><a title="" href="#"><i class="fas fa-eye"></i> <span class="text">Área do Cliente</span></a></li>
